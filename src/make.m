...
img = imread('../data/stills/images/cars053.jpg');
...
% Ayd = imfilter(A,Fyd);
% figure(20);imshow(Ayd);

integralImg = cumsum(cumsum(double(imgGray),2));
...
for yOffset=1:stepSize:(h-yD)
	for xOffset=1:stepSize:(w-xD)
